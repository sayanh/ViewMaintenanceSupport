    ...
    public void doMain(String[] args) throws IOException {
        while (true) {
            ...
            try {
                ...
                System.err.println("java de.tum.viewmaintenance.trials.SampleMain [options...] arguments...");
                // print the list of available options
                parser.printUsage(System.err);
                System.err.println();

                // print option sample. This is useful some time
                System.err.println("  Example: java de.tum.viewmaintenance.trials.SampleMain" + parser.printExample(ALL));
